...
export { literasiIndoTryoutData } from './literasi_bahasa_indonesia/literasiIndoTryoutData';

export { default as CbtTryoutLiterasiInggris } from './literasi_bahasa_inggris/CbtTryoutLiterasiInggris';
export { literasiInggrisTryoutData } from './literasi_bahasa_inggris/literasiInggrisTryoutData';

export { default as CbtTryoutPenalaranMatematika } from './penalaran_matematika/CbtTryoutPenalaranMatematika';
export { penalaranMatematikaTryoutData } from './penalaran_matematika/penalaranMatematikaTryoutData';
