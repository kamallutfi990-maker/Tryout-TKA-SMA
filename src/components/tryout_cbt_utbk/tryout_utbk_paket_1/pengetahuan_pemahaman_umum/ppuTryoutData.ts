...
export const ppuTryoutData: UtbkQuestion[] = [
  ...
  },
  {
    id: 2,
    readingText: TEKS_1,
    text: 'Padanan kata atau sinonim yang paling tepat untuk kata "kuno" pada kalimat (2) adalah ...',
    type: 'multiple',
    options: [
    ...
    correctAnswer: 'B',
    explanation: 'Jawaban: B (terdahulu)\n\nPembahasan: Berdasarkan konteks kalimat (2) ("...mempraktikkan jenis kesenian kuno ini"), kata "kuno" bermakna zaman dahulu atau terdahulu.',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation: 'Jawaban: A\n\nPembahasan: Paragraf (2) menjelaskan bagaimana ajaran Hindu dan Buddha dari India berhasil menyebar luas di Asia Tenggara karena menggunakan kesenian wayang yang sudah akrab dan mendarah daging di tengah masyarakat lokal sebagai sarananya.',
  ...
  },
  {
    ...
    correctAnswer: 'D',
    explanation: 'Jawaban: D (netral)\n\nPembahasan: Penulis memaparkan informasi sejarah perkembangan seni wayang dan pengaruh penyebaran agama secara objektif, informatif, dan tidak memihak (netral).',
  ...
  // Teks 2 (Soal No. 5 - 8)
  {
    ...
    correctAnswer: 'D',
    explanation: 'Jawaban: D (kendaraan)\n\nPembahasan: Hubungan hierarkis (hiponim-hipernim): Taksi merupakan bentuk khusus (hiponim) dari kategori umum kendaraan (hipernim/kategori tingkat atas).',
  ...
  },
  {
    ...
    correctAnswer: 'E',
    explanation: 'Jawaban: E\n\nPembahasan: Kalimat rincian membutuhkan kesejajaran bentuk (paralelisme) kata kerja aktif transitif berimbuhan me-/me-kan: "... menghadirkan taksi versi udara ..., membuat kendaraan menjadi otonom, serta menghilangkan elemen kesalahan manusia."',
  ...
  },
  {
    ...
    correctAnswer: 'D',
    explanation: 'Jawaban: D (mempertegas informasi pada kalimat sebelumnya)\n\nPembahasan: Konjungsi penegas "Bahkan" pada awal kalimat (3) berfungsi menguatkan atau mempertegas pernyataan kalimat (1) dan (2) mengenai pesatnya perkembangan dan efisiensi teknologi transportasi.',
  ...
  },
  {
    ...
    correctAnswer: 'E',
    explanation: 'Jawaban: E (kalimat 5)\n\nPembahasan: Kalimat (5) ("Flying cars atau mobil terbang sedang dikembangkan oleh sebuah perusahaan transportasi di dunia") menyatakan peristiwa/kegiatan nyata yang sedang berjalan (fakta objektif), sedangkan kalimat (3) memuat prediksi/perkiraan dan kalimat lainnya memuat opini umum.',
  ...
  // Teks 3 (Soal No. 9 - 12)
  {
    ...
    correctAnswer: 'E',
    explanation: 'Jawaban: E ((1-2-3-4-5-6-7) dan (8-9-10))\n\nPembahasan: Kalimat (1) sampai (7) menceritakan profil pribadi, aktivitas keseharian, dan kondisi kelas tempat mengajar Pak Hikmat. Mulai kalimat (8), fokus gagasan beralih ke pandangan, evaluasi, dan aspirasi kebijakan kurikulum pemerintah.',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation: 'Jawaban: A\n\nPembahasan: Inti kalimat (2) menyatakan bahwa pengalaman Hikmat saat mengajarkan musik kepada anak-anak difabel menjadi pemicu awal ketertarikannya menekuni profesi guru.',
  ...
  },
  {
    ...
    correctAnswer: 'E',
    explanation: 'Jawaban: E (10)\n\nPembahasan: Kalimat (10) rancu secara struktur sintaksis karena memuat konjungsi "agar" dan partikel penyemat "yang" di depan predikat ("... berharap agar peserta didik normal yang diberi pemahaman..."), sehingga klausa anak kehilangan predikat utama dan membuat maknanya menggantung/tidak logis.',
  ...
  },
  {
    ...
    correctAnswer: 'B',
    explanation: 'Jawaban: B\n\nPembahasan: Situasi teks menggambarkan seseorang yang menemukan minat atau jalan profesi baru berawal dari pengalaman aktivitas sebelumnya yang dijalani. Opsi B memiliki analogi situasi paling sepadan: minat menekuni cabang olahraga berkuda diawali dari pengalaman kerjanya di peternakan kuda.',
  ...
  // Teks 4 (Soal No. 13 - 16)
  {
    ...
    correctAnswer: 'E',
    explanation: 'Jawaban: E (Kebahagiaan hidup adalah dambaan semua orang.)\n\nPembahasan: Konfiks ke-an pada kata dasar sifat "sehat" -> "kesehatan" menyatakan makna hal/keadaan. Hal ini identik dengan konfiks ke-an pada kata sifat "bahagia" -> "kebahagiaan" (keadaan bahagia). Opsi A dan C menyatakan peristiwa, B menyatakan tempat, dan D menyatakan hal/posisi.',
  ...
  },
  {
    ...
    correctAnswer: 'D',
    explanation: 'Jawaban: D (alpukat menyehatkan)\n\nPembahasan: Bacaan secara terperinci memaparkan beragam nutrisi yang terkandung dalam alpukat serta kontribusi positifnya bagi kesehatan tubuh, jantung, kulit, dan diet, sehingga simpulan intinya adalah "alpukat menyehatkan".',
  ...
  },
  {
    ...
    correctAnswer: 'C',
    explanation: 'Jawaban: C\n\nPembahasan: Kalimat rumpang berada setelah pernyataan rasa buah yang hambar jika langsung dikonsumsi. Kalimat pasif yang padu, logis, dan koheren dengan subjek buah alpukat adalah: "Supaya enak dikonsumsi, alpukat perlu ditambah dengan gula atau susu." (predikat pasif: ditambah).',
  ...
  },
  {
    ...
    correctAnswer: 'C',
    explanation: 'Jawaban: C (penjelasan)\n\nPembahasan: Kalimat (9) merinci kandungan nutrisi dalam buah alpukat, lalu kalimat (10) menjelaskan manfaat dari nutrisi-nutrisi tersebut bagi kesehatan organ tubuh manusia.',
  ...
  // Teks 5 (Soal No. 17 - 20)
  {
    ...
    correctAnswer: 'A',
    explanation: 'Jawaban: A (1-4-2-3-5)\n\nPembahasan: Urutan sebab-akibat yang paling runtut dan logis:\n1. Pernyataan umum bahwa pemanasan global semakin memuncak (1).\n2. Penjelasan kondisi suhu bumi yang naik dan udara panas (4).\n3. Pengandaian berlanjutnya pemanasan yang menipiskan ozon (2).\n4. Akibat langsung sinar ultraviolet menerpa bumi tanpa halangan (3).\n5. Dampak lanjutan mencairnya es di kutub (5).',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Terjadinya pemanasan global disebabkan oleh besarnya volume gas karbon dioksida. (kalimat 6)' },
    ...
    correctAnswer: 'B',
    explanation: 'Jawaban: B (Dampak yang dirasakan dari adanya fenomena pemanasan global adalah mencairnya es di Kutub Utara. [kalimat 5])\n\nPembahasan: Pola dasar kalimat contoh adalah Subjek (S) yang diperluas klausa sematan + Predikat Kopula Berdefinisi (adalah) + Pelengkap/Klausa Nomina (Pel). Kalimat (5) memiliki pola sintaksis yang persis sama dengan predikat kopula "adalah".',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation: 'Jawaban: A (sinar ultraviolet [kalimat 3])\n\nPembahasan: Frasa "pohon jati" berpola Diterangkan-Menerangkan (DM) dengan struktur: [Nama Kelas/Genus] + [Nama Jenis/Spesifik]. Frasa "sinar ultraviolet" memiliki pola makna identik: "sinar" (kelas radiasi/pancaran) + "ultraviolet" (nama spektrum/jenis khususnya).',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation: 'Jawaban: A (lapisan ozon akan menipis karena pemanasan global)\n\nPembahasan: Bentuk verba "berubah menjadi tipis" tidak efektif dan pleonasme. Dalam tata bahasa baku bahasa Indonesia, bentuk yang lugas, padat, dan efektif untuk menyatakan proses menjadi tipis adalah verba "akan menipis".',
