...
export { literasiIndoTryoutData, literasiIndoTryoutData as litIndoTryoutData } from './literasi_bahasa_indonesia/literasiIndoTryoutData';

export { default as CbtTryoutLiterasiInggris } from './literasi_bahasa_inggris/CbtTryoutLiterasiInggris';
export { literasiInggrisTryoutData, literasiInggrisTryoutData as litInggrisTryoutData } from './literasi_bahasa_inggris/literasiInggrisTryoutData';

export { default as CbtTryoutPenalaranMatematika } from './penalaran_matematika/CbtTryoutPenalaranMatematika';
export { penalaranMatematikaTryoutData, penalaranMatematikaTryoutData as penalaranMtkTryoutData } from './penalaran_matematika/penalaranMatematikaTryoutData';
