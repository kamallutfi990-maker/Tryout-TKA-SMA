...
export default function DashboardGuru({ userProfile, onLogout }: DashboardGuruProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 flex flex-col font-sans transition-colors duration-200" id="dashboard-guru">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="text-[10px] text-blue-600 dark:text-blue-400 font-bold uppercase tracking-wider">Dashboard Guru Pengajar</span>
            </div>
          </div>

          <div className="flex items-center gap-4">
            <div className="text-right">
              <span className="text-sm font-bold text-slate-800 dark:text-slate-200 block">Guru: {userProfile.displayName}</span>
              <span className="text-xs text-slate-400 dark:text-slate-500">Pengajar TKA Nasional</span>
            </div>
            <button
              onClick={onLogout}
